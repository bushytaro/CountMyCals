...
import { Target, Flame, Beef, Wheat, Droplets, ArrowRight, ShoppingBag, ChefHat, Check } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700">
      ...
      {/* Weekly Budget Peek */}
      <div className="mt-8">
        <Card className="bg-accent/10 border-accent/20 rounded-3xl">
          <CardContent className="p-6 md:p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              <h3 className="text-xl font-serif text-foreground mb-2">Weekly Grocery Budget</h3>
              <p className="text-muted-foreground">Objectif de dépenses : environ €{profile?.grocery_budget} cette semaine.</p>
            </div>
            <Link href="/profile" className="whitespace-nowrap px-6 py-3 bg-background border border-border rounded-xl font-medium shadow-sm hover:shadow-md transition-all">
              Modifier le budget
            </Link>
          </CardContent>
        </Card>
